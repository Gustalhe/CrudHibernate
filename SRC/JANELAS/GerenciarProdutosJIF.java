 ...
 * @author IFPR
 */
public class GerenciarProdutosJIF extends javax.swing.JInternalFrame implements WindowListener{

    /**
     * Creates new form GerenciarProdutosJIF
     */
    public GerenciarProdutosJIF(JFrame parent) {
        
        gerProduto = new GerenciarProduto();
        produtoForm = new ProdutoForm(parent, true, gerProduto);
        produtoTableModel = new ProdutoTableModel(gerProduto);
        initComponents();
       produtoForm.addWindowListener(this);
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(nomePesquisaTF, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(pesquisarBT)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(limparBT, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        produtosTB.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
    ...
    private void novoBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_novoBTActionPerformed
        ...
        produtoForm.setProduto(new Produto());
    ...
    private void produtosTBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_produtosTBMouseClicked
        ...
        //int linha = produtosTB.getSelectedRow();
        
       // if(linha >= 0){
         //   Produto prod = (Produto) produtoTableModel.getValueAt(linha, 4);
           // int opcao = JOptionPane.showConfirmDialog(this, "Deseja realmente excluir "+ "o produto"+ prod.getNome() + "?");
        //if(opcao == JOptionPane.YES_OPTION){
          //  gerProduto.remover(prod.getId());
          //  }
        //}
    ...
    private void removerBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removerBTActionPerformed
        ...
        if(linha >= 0){
            Produto prod = (Produto) produtoTableModel.getValueAt(linha, 4);
            int opcao = JOptionPane.showConfirmDialog(this, "Deseja realmente excluir "+ "o produto"+ prod.getNome() + "?", "Confirmar exclusão?", JOptionPane.YES_NO_OPTION);
        if(opcao == JOptionPane.YES_OPTION){
            gerProduto.remover(prod.getId());
    ...
    private void editarBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarBTActionPerformed
        // TODO add your handling code here:
         int linha = produtosTB.getSelectedRow();
          ...
          if(linha >= 0){
            Produto prod = (Produto) produtoTableModel.getValueAt(linha, 4);
            produtoForm.setProduto(prod);
            produtoForm.objectToForm();
            produtoForm.setVisible(true);
    ...
    private void pesquisarBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pesquisarBTActionPerformed
        ...
        if(!nomePesq.isEmpty()){
          Collection<Produto> resultados = gerProduto.listar(nomePesq);
          produtoTableModel.setProdutos(resultados);
          produtoTableModel.popularTableData();
